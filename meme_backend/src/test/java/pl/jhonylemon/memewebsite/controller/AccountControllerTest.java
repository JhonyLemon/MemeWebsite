...
import pl.jhonylemon.memewebsite.model.AccountPutPasswordUserModelApi;
...
class AccountControllerTest {
    ...
    void banAccountTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH+ ApiPaths.Account.ACCOUNT_ID + ApiPaths.Account.ACCOUNT_UPDATE_BAN,
                                account.getId(),true
                        )
    ...
    void changeAccountRoleTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH+ ApiPaths.Account.ACCOUNT_ID + ApiPaths.Account.ACCOUNT_UPDATE_ROLE,
                                account.getId(),1L
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void createAccountTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .post(ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH+ ApiPaths.Account.ACCOUNT_REGISTER)
    ...
    void deleteAccountTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .delete(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH+ ApiPaths.Account.ACCOUNT_ID,
                                account1.getId()
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void deleteAccountSelfTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .delete(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH,
                                account.getId()
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void getAccountRoleTest_Success() throws Exception {
        Account account = Account.builder()
                .profilePicture(profilePhotoRepository.findByDefaultProfileTrue().orElse(null))
                .password("123456789")
                .name("Gacek")
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .get(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_ID + ApiPaths.Account.ACCOUNT_ROLE,
                                account.getId()
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void getAllAccountsTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .post(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_GET_ALL_PAGINATED,
    ...
    void getSelfTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .get(ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH)
                        .contentType(MediaType.APPLICATION_JSON)
                )
                .andExpect(status().isOk());
    }
    ...
    void updateAccountNameTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_ID + ApiPaths.Account.ACCOUNT_UPDATE_NAME,
                                account.getId(),
                                "Gacek1"
                        )
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateAccountNameSelfTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 + ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_UPDATE_NAME,
                                "Gacek1"
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    void updateAccountPasswordTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(ApiPaths.Version.v1 +ApiPaths.Account.ACCOUNT_PATH +
                                        ApiPaths.Account.ACCOUNT_ID +
    ...
    void updateAccountPasswordSelfTest_Success() throws Exception {
        ...
        AccountPutPasswordUserModelApi accountPutPasswordDto = new AccountPutPasswordUserModelApi();
        accountPutPasswordDto.setNewPassword("987654321");
        accountPutPasswordDto.setOldPassword("123456789");

        mockMvc.perform(MockMvcRequestBuilders
                        .put(ApiPaths.Version.v1 +ApiPaths.Account.ACCOUNT_PATH +
                                ApiPaths.Account.ACCOUNT_UPDATE_PASSWORD)
                        .content(objectMapper.writeValueAsString(accountPutPasswordDto))
                        .contentType(MediaType.APPLICATION_JSON)
                )
                .andExpect(status().isOk());
    ...
    void updateAccountProfilePictureTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 +ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_ID + ApiPaths.Account.ACCOUNT_UPDATE_PHOTO,
                                account.getId(),
                                1L
                        )
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateAccountProfilePictureSelfTest_Success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .put(
                                ApiPaths.Version.v1 +ApiPaths.Account.ACCOUNT_PATH + ApiPaths.Account.ACCOUNT_UPDATE_PHOTO,
                                1L
                        )
                        .contentType(MediaType.APPLICATION_JSON)
                )
