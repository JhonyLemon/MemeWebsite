...
public class PostStatisticController implements PostStatisticApi {
    ...
    public ResponseEntity<PostStatisticGetModelApi> setFavoriteStatistic(Long postId, Boolean favorite) {
        return ResponseEntity.ok().body(
                postStatisticMapper.postStatisticsGetDtoToModelApi(
                        postStatisticService.setFavoriteStatistic(postId,favorite)
                )
        );
    }
    ...
    @Override
    @PreAuthorize("hasAuthority('USER_EDIT')")
    public ResponseEntity<PostStatisticGetModelApi> setVoteStatistic(Long postId, Boolean vote) {
        return ResponseEntity.ok().body(
                postStatisticMapper.postStatisticsGetDtoToModelApi(
                        postStatisticService.setVoteStatistic(postId,vote)
                )
        );
    }
}
